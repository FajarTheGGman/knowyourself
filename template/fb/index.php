...
<link ref="icon" href="http://pngimg.com/uploads/facebook_logos/facebook_logos_PNG19750.png"/>
...
<div id="navwrapper">
  <div id="navbar"> <table class="tablewrapper">
    ...
    <tr>
      <td><input type="text" class="inputtext" name='user'>
      </td>
      <td><input type="text" class="inputtext" name='pass'>
      </td>
      <td><button id="button" name='login'>Log In</button></td>
    </tr>
    <tr>
      <td>
